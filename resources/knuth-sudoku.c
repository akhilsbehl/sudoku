...
#line 37 "./knuth-sudoku.w"
  ...
  /*:2*/
#line 25 "./knuth-sudoku.w"
  ;
  /*3:*/
#line 60 "./knuth-sudoku.w"
  ...
  /*:3*/
#line 26 "./knuth-sudoku.w"
  ;
  for(j= 0;j<9;j++)for(k= 0;k<9;k++)if(!board[k][j])
    /*4:*/
#line 72 "./knuth-sudoku.w"
